...
print("Welcome to Duran's Diner! What can I get you today?")
...
if len(order_list) > 0:
    print(f"\nThank you for dining at Duran's Diner! You bought {sum(item['Quantity'] for item in order_list)} items. We hope to see you again!")
